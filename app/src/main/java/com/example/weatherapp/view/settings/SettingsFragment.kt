        ...
        binding.groupLocation.setOnCheckedChangeListener{ group , checkedId ->
            when(checkedId){
                binding.map.id ->{
                    ...
                    mainViewModel.updateLocationShared()
